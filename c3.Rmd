...
Eine ICC kann alleine unter Kenntnis des Schwierigkeitsparameters der Aufgabe erstellt werden. Sie lässt sich nutzen, um graphisch zu beurteilen, inwiefern das tatsächliche Lösungsverhalten der Probanden von dem Verhalten, welches mithilfe des Rasch-Modells vorhergesagt wird, abweicht.

Naiv würde man davon ausgehen, dass man nur die tatsächlichen Lösungswahrscheinlichkeiten in Abhängigkeit von den Fähigkeiten der Probanden eintragen müsste (so macht man es auch bspw. im Physikunterricht, bei der ersten graphischen linearen Regression). Diese Lösungswahrscheinlichkeiten sind aber nicht für einzelne Probanden, sondern nur für Gruppen, direkt beobachtbar. Aufgrunddessen werden die Probanden in Fähigkeitsgruppen eingeteilt (Binning). Der Prozentsatz einer bestimmten Gruppe, der die Aufgabe richtig gelöst hat, entspricht dann der Lösungswahrscheinlichkeit.
