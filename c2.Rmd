...
## Modellschätzung
Der folgende Code initiiert die Schätzung eines Rasch-Modells für den vorliegenden Datensatz. Das Listen-Objekt `mod1PL` mit vielen Einträgen wird erzeugt. Der angezeigte Output wird im Folgenden erläutert.

```{r Rasch-Modell, results='asis'}
